...
**Video 1: Running the KLAM Project**

https://github.com/user-attachments/assets/demo_run_project.mp4

Shows how to launch and run the application with basic usage workflow.

---

**Video 2: Adding Files to the Project**

https://github.com/user-attachments/assets/demo_add_files.mp4

Demonstrates how to add and configure files in the project.
